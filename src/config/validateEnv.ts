...
const {
  ...
  MAINNET_AXELAR_ARCHIVE_RPC_BASE_URLS,
  MAINNET_AXELAR_ARCHIVE_REST_BASE_URLS,
...
const urlArrays: { [x: string]: string[] } = {
  ...
  mainnetAxelarArchiveRpcBaseUrls: parseStringArray(MAINNET_AXELAR_ARCHIVE_RPC_BASE_URLS),
  mainnetAxelarArchiveRestBaseUrls: parseStringArray(MAINNET_AXELAR_ARCHIVE_REST_BASE_URLS),
...
export const validateEnv = (): AppConfigType => {
  try {
    ...
    return {
      ...
      mainnetAxelarArchiveRpcBaseUrls: urlArrays.mainnetAxelarArchiveRpcBaseUrls,
      mainnetAxelarArchiveRestBaseUrls: urlArrays.mainnetAxelarArchiveRestBaseUrls,
